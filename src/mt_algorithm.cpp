...
{
    objects.push_back(new Sphere(float3{2.f, 0, -2}, 0.4f));

    Vertex a(float3{-0.5f, -0.5f, -2}, float3{0, 0, 1}, float3(), float3{1, 0, 0});
...
Triangle::Triangle() : a(float3{0, 0, 0}), b(float3{0, 0, 0}), c(float3{0, 0, 0}) {}
